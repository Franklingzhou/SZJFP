...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    let query = supabase
      .from('resume_reviews')
      .select('id, worker_id, type, review_type, old_data, new_data, changes, status, reviewer_id, review_note, reviewed_at, created_at, proposed_data, original_data, changed_fields, workers(name, job_types, origin)')
