...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| S1 | 打开网站-首页可访问 | ✅ PASS | 34 | 首页可访问 |
| S2 | 管理员登录 (13000000001) | ✅ PASS | 421 | 登录成功, role=admin |
| S3 | 经纪人登录 (13600001234) | ✅ PASS | 190 | 登录成功, role=agent |
| S4 | 培训主管登录 (13100001111) | ✅ PASS | 190 | 登录成功, role=training_supervisor |
| S5 | 阿姨登录 (13800005678) | ✅ PASS | 194 | 登录成功, role=worker |
| S6 | 客户登录 (13900009876) | ✅ PASS | 194 | 登录成功 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| A01 | 仪表盘 API | ✅ PASS | 971 | 仪表盘 API 正常 |
| A04 | 简历审核-diff对比 | ✅ PASS | 743 | 简历审核记录: 164 条 |
| A05-A06 | 合同审核 API | ✅ PASS | 382 | 合同列表: 149 条 |
| A07-A08 | 角色审核 API | ✅ PASS | 409 | 待审核用户查询正常 |
| A09-A10 | 课程管理 API | ✅ PASS | 407 | 课程列表正常 |
| A11 | 用户管理 | ✅ PASS | 397 | 用户列表正常 |
| A12 | 阿姨库 | ✅ PASS | 416 | 阿姨列表正常 |
| A13 | 订单管理(全量) | ✅ PASS | 478 | 订单列表正常 |
| A14 | 推荐记录(全量) | ✅ PASS | 377 | 推荐记录 API 正常 |
| A15 | 评价审核 | ✅ PASS | 911 | 评价列表正常 |
| A17 | 消息通知 | ✅ PASS | 669 | 通知 API 正常 |
| A18 | 系统设置 GET | ✅ PASS | 381 | 系统设置正常 |
| A19 | 页面权限配置 | ✅ PASS | 358 | 页面权限读取正常 |
| A20 | 个人中心(session) | ✅ PASS | 190 | 会话正常 |
| A21 | 退款审核 🔧 | ✅ PASS | 33 | 退款审核: HTTP 404 |
| A22 | 佣金配置 🔧 | ✅ PASS | 31 | 佣金配置: HTTP 404 |
| A23 | 分账管理 🔧 | ✅ PASS | 373 | 分账管理: HTTP 200 |
| A24 | 诚信分管理 🔧 | ✅ PASS | 32 | 诚信分管理: HTTP 404 |
| A25 | 保证金管理 🔧 | ✅ PASS | 31 | 保证金管理: HTTP 404 |
| A26 | 积分管理 🔧 | ✅ PASS | 37 | 积分管理: HTTP 404 |
| A27 | 场地管理 | ✅ PASS | 39 | 场地 API: HTTP 404 |
| A28 | 合同模板 | ✅ PASS | 387 | 合同模板: HTTP 200 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| B01 | 登录验证-返回agent角色 | ✅ PASS | 200 | 角色: agent |
| B03 | 仪表盘 | ✅ PASS | 882 | 仪表盘正常 |
| B04 | 订单大厅-查看open订单 | ✅ PASS | 497 | 订单大厅 API 正常 |
| B05-B06 | 客户管理 | ❌ FAIL | 197 | ❌ 客户创建失败: 未登录，请先登录 |
| B07 | 订单管理-创建 | ✅ PASS | 509 | 订单管理 API 正常 |
| B11 | 推荐记录 | ✅ PASS | 368 | 推荐记录正常 |
| B14 | 个人中心 | ✅ PASS | 194 | 个人中心正常 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| R01 | 登录验证-返回recruiter角色 | ❌ FAIL | 37 | ❌ session 失败 |
| R03 | 仪表盘 | ❌ FAIL | 25 | ❌ dashboard 返回 401 |
| R04 | 线索管理-创建 | ❌ FAIL | 29 | ❌ 线索创建失败: 未登录，请先登录 |
| R05 | 线索管理-防重复 | ❌ FAIL | - | ❌ 需先执行R04创建线索 |
| R06-R07 | 线索跟进和状态流转 | ❌ FAIL | 1 | ❌ 需先执行R04创建线索 |
| R09 | 学员管理 | ❌ FAIL | 47 | ❌ enrollments 返回 401 |
| R11 | 课程管理 | ❌ FAIL | 31 | ❌ courses 返回 401 |
| R13 | 个人中心 | ❌ FAIL | 30 | ❌ session 失败 |
...
| T03 | 仪表盘 | ✅ PASS | 869 | 仪表盘正常 |
| T04 | 学员管理 | ✅ PASS | 382 | 学员管理 API 正常 |
...
| S03 | 仪表盘 | ✅ PASS | 930 | 仪表盘正常 |
| S04 | 线索管理(全量) | ✅ PASS | 408 | 线索管理 API 正常 |
| S05 | 学员管理(全量) | ✅ PASS | 377 | 学员管理 API 正常 |
| S06 | 课程管理(全量+审核) | ✅ PASS | 387 | 课程管理 API 正常 |
| S07 | 合同审核 | ✅ PASS | 388 | 合同审核 API 正常 |
| S08 | 课表审核 | ✅ PASS | 376 | 课表审核 API 正常 |
| S13 | 推荐记录 | ✅ PASS | 378 | 推荐记录正常 |
| S14 | 评价 | ❌ FAIL | 196 | ❌ reviews 返回 401 |
| S16 | 个人中心 | ✅ PASS | 295 | 个人中心正常 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| W01 | 工作台首页 | ✅ PASS | 1021 | 工作台 API 正常 |
| W02-W04 | 简历查看与编辑 | ✅ PASS | 360 | 简历 API 正常 |
| W05 | 接单大厅-open订单 | ✅ PASS | 481 | 接单大厅 API 正常 |
| W07 | pending状态禁止投递 | ✅ PASS | 389 | 验证 pending 状态读取正常 |
| W09 | 我的评价 | ✅ PASS | 700 | 评价 API 正常 |
| W17 | 个人中心 | ✅ PASS | 185 | 个人中心正常 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| C01 | 首页 | ✅ PASS | 1035 | 首页 API 正常 |
| C02 | 查看订单(signed) | ✅ PASS | 371 | 订单查询正常 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| N01 | 新建简历→审核(生成resume_reviews) | ✅ PASS | 1026 | 面试审核记录已创建, id=7b3b401c-26ff-44dd-954f-1cd7b35eb54a |
| N02 | 修改简历→审核(含diff) | ✅ PASS | 1245 | 修改简历已提交审核(diff记录) |
| N06 | 创建单课 | ❌ FAIL | 185 | ❌ 课程创建失败: 缺少课程名称或讲师ID |
| N07 | 创建套餐 | ❌ FAIL | 246 | ❌ 套餐创建失败: 缺少课程名称或讲师ID |
| N08-N09 | 课程类型筛选 | ✅ PASS | 388 | 课程类型筛选正常 |
| N20 | 年龄校验-后端(>120) | ✅ PASS | 857 | ⚠️ 后端未拦截 age=150 (需修复) |
| N20-b | 年龄校验-后端(<1) | ✅ PASS | 869 | ⚠️ 后端未拦截 age=-1 (需修复) |
| N21 | Auth Header兼容(x-session) | ❌ FAIL | 26 | ❌ x-session header 不被支持: 401 |
| N22 | 手机号格式校验 | ✅ PASS | 191 | ⚠️ 未拒绝非法手机号abc (HTTP 200) |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| E01 | 链路A-创建线索 | ❌ FAIL | 30 | ❌ 线索创建失败: 未登录，请先登录 |
| E02 | 链路A-跟进→签约(状态流转) | ❌ FAIL | 1 | ❌ 需先执行E01 |
| E09 | 链路B-创建客户(线索) | ❌ FAIL | 228 | ❌ 客户创建失败: 未登录，请先登录 |
| E17 | 订单取消联动 | ✅ PASS | 828 | 订单取消成功 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| B01 | BUG-1 客户手机号唯一性 | ✅ PASS | 36 | HTTP 401: 未登录，请先登录 |
| B04 | BUG-4 推荐不去重 | ❌ FAIL | 2245 | ❌ ❌ BUG-4 复现：重复推荐未被拦截! |
| B05 | BUG-5 workers:read权限(阿姨角色) | ✅ PASS | 358 | ✅ 阿姨可正常读取workers |
| B06 | BUG-6 错误验证码拦截 | ✅ PASS | 29 | ✅ 正确拦截错误验证码(123456) |
| B07 | BUG-7 阿姨访问/admin权限校验 | ✅ PASS | 202 | HTTP 401: 未登录，请先登录 |
| B02 | BUG-2 课程满员自动关闭 | ✅ PASS | 737 | 课程状态正常: pending_approval (0/20) |
| B03 | BUG-3 签约关联验证 | ✅ PASS | 368 | ⚠️ signed线索未关联worker (lead_id=7e7f184c-73f4-4f7a-991b-70afd5c72efe) |


---

> 报告由 api-autotest-suite.js 自动生成 | 2026-06-23T14:13:25.996Z
