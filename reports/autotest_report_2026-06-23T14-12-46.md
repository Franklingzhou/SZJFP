...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| S1 | 打开网站-首页可访问 | ✅ PASS | 78 | 首页可访问 |
| S2 | 管理员登录 (13000000001) | ✅ PASS | 568 | 登录成功, role=admin |
| S3 | 经纪人登录 (13600001234) | ✅ PASS | 233 | 登录成功, role=agent |
| S4 | 培训主管登录 (13100001111) | ✅ PASS | 221 | 登录成功, role=training_supervisor |
| S5 | 阿姨登录 (13800005678) | ✅ PASS | 232 | 登录成功, role=worker |
| S6 | 客户登录 (13900009876) | ✅ PASS | 226 | 登录成功 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| A01 | 仪表盘 API | ✅ PASS | 1036 | 仪表盘 API 正常 |
| A04 | 简历审核-diff对比 | ✅ PASS | 786 | 简历审核记录: 160 条 |
| A05-A06 | 合同审核 API | ✅ PASS | 408 | 合同列表: 149 条 |
| A07-A08 | 角色审核 API | ✅ PASS | 388 | 待审核用户查询正常 |
| A09-A10 | 课程管理 API | ✅ PASS | 410 | 课程列表正常 |
| A11 | 用户管理 | ✅ PASS | 406 | 用户列表正常 |
| A12 | 阿姨库 | ✅ PASS | 427 | 阿姨列表正常 |
| A13 | 订单管理(全量) | ✅ PASS | 507 | 订单列表正常 |
| A14 | 推荐记录(全量) | ✅ PASS | 381 | 推荐记录 API 正常 |
| A15 | 评价审核 | ✅ PASS | 1086 | 评价列表正常 |
| A17 | 消息通知 | ✅ PASS | 402 | 通知 API 正常 |
| A18 | 系统设置 GET | ✅ PASS | 371 | 系统设置正常 |
| A19 | 页面权限配置 | ✅ PASS | 375 | 页面权限读取正常 |
| A20 | 个人中心(session) | ✅ PASS | 200 | 会话正常 |
| A21 | 退款审核 🔧 | ✅ PASS | 42 | 退款审核: HTTP 404 |
| A22 | 佣金配置 🔧 | ✅ PASS | 34 | 佣金配置: HTTP 404 |
| A23 | 分账管理 🔧 | ✅ PASS | 376 | 分账管理: HTTP 200 |
| A24 | 诚信分管理 🔧 | ✅ PASS | 39 | 诚信分管理: HTTP 404 |
| A25 | 保证金管理 🔧 | ✅ PASS | 37 | 保证金管理: HTTP 404 |
| A26 | 积分管理 🔧 | ✅ PASS | 35 | 积分管理: HTTP 404 |
| A27 | 场地管理 | ✅ PASS | 47 | 场地 API: HTTP 404 |
...
| B03 | 仪表盘 | ✅ PASS | 1013 | 仪表盘正常 |
| B04 | 订单大厅-查看open订单 | ✅ PASS | 525 | 订单大厅 API 正常 |
| B05-B06 | 客户管理 | ❌ FAIL | 190 | ❌ 客户创建失败: 未登录，请先登录 |
| B07 | 订单管理-创建 | ✅ PASS | 653 | 订单管理 API 正常 |
| B11 | 推荐记录 | ✅ PASS | 398 | 推荐记录正常 |
| B14 | 个人中心 | ✅ PASS | 233 | 个人中心正常 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| R01 | 登录验证-返回recruiter角色 | ❌ FAIL | 31 | ❌ session 失败 |
| R03 | 仪表盘 | ❌ FAIL | 23 | ❌ dashboard 返回 401 |
| R04 | 线索管理-创建 | ❌ FAIL | 34 | ❌ 线索创建失败: 未登录，请先登录 |
| R05 | 线索管理-防重复 | ❌ FAIL | - | ❌ 需先执行R04创建线索 |
| R06-R07 | 线索跟进和状态流转 | ❌ FAIL | - | ❌ 需先执行R04创建线索 |
| R09 | 学员管理 | ❌ FAIL | 36 | ❌ enrollments 返回 401 |
| R11 | 课程管理 | ❌ FAIL | 32 | ❌ courses 返回 401 |
| R13 | 个人中心 | ❌ FAIL | 40 | ❌ session 失败 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| T01 | 登录验证-返回instructor角色 | ✅ PASS | 197 | 角色: instructor |
| T03 | 仪表盘 | ✅ PASS | 1079 | 仪表盘正常 |
| T04 | 学员管理 | ✅ PASS | 375 | 学员管理 API 正常 |
| T07 | 课程管理 | ✅ PASS | 411 | 课程管理 API 正常 |
| T08 | 排课管理 | ✅ PASS | 387 | 排课管理 API 正常 |
| T12 | 个人中心 | ✅ PASS | 209 | 个人中心正常 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| S01 | 登录验证-返回training_supervisor角色 | ✅ PASS | 205 | 角色: training_supervisor |
| S03 | 仪表盘 | ✅ PASS | 1059 | 仪表盘正常 |
| S04 | 线索管理(全量) | ✅ PASS | 415 | 线索管理 API 正常 |
| S05 | 学员管理(全量) | ✅ PASS | 351 | 学员管理 API 正常 |
| S06 | 课程管理(全量+审核) | ✅ PASS | 390 | 课程管理 API 正常 |
| S07 | 合同审核 | ✅ PASS | 426 | 合同审核 API 正常 |
| S08 | 课表审核 | ✅ PASS | 409 | 课表审核 API 正常 |
| S13 | 推荐记录 | ✅ PASS | 368 | 推荐记录正常 |
| S14 | 评价 | ❌ FAIL | 195 | ❌ reviews 返回 401 |
| S16 | 个人中心 | ✅ PASS | 228 | 个人中心正常 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| W01 | 工作台首页 | ✅ PASS | 1023 | 工作台 API 正常 |
| W02-W04 | 简历查看与编辑 | ✅ PASS | 396 | 简历 API 正常 |
| W05 | 接单大厅-open订单 | ✅ PASS | 495 | 接单大厅 API 正常 |
| W07 | pending状态禁止投递 | ✅ PASS | 389 | 验证 pending 状态读取正常 |
| W09 | 我的评价 | ✅ PASS | 742 | 评价 API 正常 |
| W17 | 个人中心 | ✅ PASS | 210 | 个人中心正常 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| C01 | 首页 | ✅ PASS | 948 | 首页 API 正常 |
| C02 | 查看订单(signed) | ✅ PASS | 380 | 订单查询正常 |
| C06 | 个人中心 | ✅ PASS | 253 | 个人中心正常 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| N01 | 新建简历→审核(生成resume_reviews) | ✅ PASS | 1228 | 面试审核记录已创建, id=1a9594ef-7603-4094-b495-7c1f3e32436b |
| N02 | 修改简历→审核(含diff) | ✅ PASS | 1133 | 修改简历已提交审核(diff记录) |
| N06 | 创建单课 | ❌ FAIL | 203 | ❌ 课程创建失败: 缺少课程名称或讲师ID |
| N07 | 创建套餐 | ❌ FAIL | 258 | ❌ 套餐创建失败: 缺少课程名称或讲师ID |
| N08-N09 | 课程类型筛选 | ✅ PASS | 401 | 课程类型筛选正常 |
| N20 | 年龄校验-后端(>120) | ✅ PASS | 891 | ⚠️ 后端未拦截 age=150 (需修复) |
| N20-b | 年龄校验-后端(<1) | ✅ PASS | 896 | ⚠️ 后端未拦截 age=-1 (需修复) |
| N21 | Auth Header兼容(x-session) | ❌ FAIL | 45 | ❌ x-session header 不被支持: 401 |
| N22 | 手机号格式校验 | ✅ PASS | 207 | ⚠️ 未拒绝非法手机号abc (HTTP 200) |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| E01 | 链路A-创建线索 | ❌ FAIL | 35 | ❌ 线索创建失败: 未登录，请先登录 |
| E02 | 链路A-跟进→签约(状态流转) | ❌ FAIL | - | ❌ 需先执行E01 |
| E09 | 链路B-创建客户(线索) | ❌ FAIL | 205 | ❌ 客户创建失败: 未登录，请先登录 |
| E17 | 订单取消联动 | ✅ PASS | 890 | 订单取消成功 |
...
| # | 测试项 | 状态 | 耗时(ms) | 详情 |
|---|--------|------|----------|------|
| B01 | BUG-1 客户手机号唯一性 | ✅ PASS | 30 | HTTP 401: 未登录，请先登录 |
| B04 | BUG-4 推荐不去重 | ❌ FAIL | 2248 | ❌ ❌ BUG-4 复现：重复推荐未被拦截! |
| B05 | BUG-5 workers:read权限(阿姨角色) | ✅ PASS | 377 | ✅ 阿姨可正常读取workers |
| B06 | BUG-6 错误验证码拦截 | ✅ PASS | 40 | ✅ 正确拦截错误验证码(123456) |
| B07 | BUG-7 阿姨访问/admin权限校验 | ✅ PASS | 201 | HTTP 401: 未登录，请先登录 |
| B02 | BUG-2 课程满员自动关闭 | ✅ PASS | 780 | 课程状态正常: pending_approval (0/20) |
| B03 | BUG-3 签约关联验证 | ✅ PASS | 364 | ⚠️ signed线索未关联worker (lead_id=7e7f184c-73f4-4f7a-991b-70afd5c72efe) |


---

> 报告由 api-autotest-suite.js 自动生成 | 2026-06-23T14:12:46.153Z
